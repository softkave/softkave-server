...
export default function setupUserRESTEndpoints(ctx: IBaseContext, app: Express) {
  const endpoints = {
    ...
    newAnonymousUser: wrapEndpointREST(newAnonymousUser, ctx),
  };
  ...
  app.post(`${baseURL}/changePasswordWithToken`, endpoints.changePasswordWithToken);
  ...
  app.post(`${baseURL}/newAnonymousUser`, endpoints.newAnonymousUser);
}

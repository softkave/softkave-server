...
export interface ICustomPropertyDbProvider {
  ...
  assertGetCustomPropertyById: (ctx: IBaseContext, customId: string) => Promise<ICustomProperty>;
  getMany: (ctx: IBaseContext, ids: string[]) => Promise<ICustomProperty[]>;
  getManyByParentId: (ctx: IBaseContext, id: string) => Promise<ICustomProperty[]>;
  ...
  customPropertyExists: (ctx: IBaseContext, name: string, boardId: string) => Promise<boolean>;
  deleteCustomProperty: (ctx: IBaseContext, custompropertyId: string) => Promise<void>;
}

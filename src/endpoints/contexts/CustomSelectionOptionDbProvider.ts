...
export interface ICustomSelectionOptionDbProvider {
  ...
  assertGetOptionById: (ctx: IBaseContext, customId: string) => Promise<ICustomSelectionOption>;
  assertOptionById: (ctx: IBaseContext, customId: string) => Promise<boolean>;
  getMany: (ctx: IBaseContext, ids: string[]) => Promise<ICustomSelectionOption[]>;
  updateOptionById: (
    ctx: IBaseContext,
    customId: string,
  ...
  deleteOption: (ctx: IBaseContext, customselectionoptionId: string) => Promise<void>;
  parentHasOptions: (
    ctx: IBaseContext,

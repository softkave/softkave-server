...
export type ExtractFieldTransformer<T, Result = any, ExtraArgs = any, T1 = object> = (
  val: T,
  extraArgs: ExtraArgs,
  data: T1
) => Result;
  ...
  [Key in keyof Required<T>]: T[Key] extends ScalarTypes
    ?
        ...
        | ExtractFieldTransformer<
            ...
            T
          >
    : ExtractFieldTransformer<NonNullable<Required<T>[Key]>, Required<Result>[Key], ExtraArgs, T>;
};

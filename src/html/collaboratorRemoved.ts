...
export interface ICollaboratorRemovedEmailProps extends IBaseEmailTemplateProps {
...
export function collaboratorRemovedEmailHTML(props: ICollaboratorRemovedEmailProps) {
...
export function collaboratorRemovedEmailText(props: ICollaboratorRemovedEmailProps) {
  const txt = `

...
export function forgotPasswordEmailHTML(props: IForgotPasswordEmailProps): string {
  return `
  <!DOCTYPE html>
  <html lang="en-US">
  <head>
...
export function forgotPasswordEmailText(props: IForgotPasswordEmailProps): string {
  const text = `
